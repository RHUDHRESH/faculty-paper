...
export function DataTable<T>({
  ...
  return (
    <div className={cn("relative overflow-hidden surface-card", className)}>
      <div
        ref={scroller}
            ...
            <tr>
              {columns.map((c) => (
                <th
                  ...
                  scope="col"
                  className={cn(
                    // The whole point: still there at row 200.
                    "sticky top-0 z-10 whitespace-nowrap border-b border-border bg-card px-3 py-2.5",
      ...
      {/* Edges, so a column off-screen is visibly off-screen. */}
      <div
        aria-hidden
        className={cn(
