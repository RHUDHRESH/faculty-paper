...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        // A dimming scrim, not a backdrop-blur: blurs stack when a dialog opens
        // over a sheet, so the layer underneath came out doubly smeared and read
        // as the page randomly going out of focus.
