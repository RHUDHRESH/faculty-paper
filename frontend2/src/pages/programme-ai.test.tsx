...
import { CollegeResearch } from "@/pages/programme"
import { FACULTY, fakeApi, renderWithProviders } from "@/test/harness"

/**
 * The "what to try next" panel on the college research page, in the two states a
...
describe("College research — the model's panel", () => {
